...
bodyTag.style.background = "#0a122d"
// todo-2
const imageTag = document.querySelector("#strangeFish")
imageTag.style.margin = "4rem 0"
// todo-3
imageTag.style.border= "1 rem"
// todo-4
const h1Tag = document.querySelector(".hero__title")
const h5Tag = document.querySelector(".hero__subtitle")
// check